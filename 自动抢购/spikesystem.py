...
class SpikeSystem(object):
    ...
    def taobao(self):
        self.login('//*[@id="header"]/div/div/a[2]', 'https://cart.taobao.com/cart.htm',
                   '//*[@id="login"]/div[1]/i')
        self.choice('//*[@id="J_SelectAll1"]/div/label')
    ...
    def jd(self):
        ...
        self.choice('//*[@id="cart-body"]/div[2]/div[3]/div[1]/div/input')
        self.seckill(
    ...
    def suning(self):
        ...
        self.choice('//*[@id="chooseAllCheckFrame2"]')
    ...
    def vivo(self):
        ...
        self.choice('//*[@id="fixed-bottom-bar"]/div/div/div[1]/ul/li[1]/label/a')
    ...
    def xiaomi(self):
        ...
        self.choice('//*[@id="app"]/div[2]/div/div/div/div[1]/div[2]/div[1]/div[1]/i')
    ...
    def huawei(self):
        ...
        self.choice('//*[@id="app"]/div[2]/div[3]/div[4]/div/div[1]/label/input')
